        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    author_life = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    author_books = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    book_writer = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    book_subject = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    book_page = table.Column<string>(type: "nvarchar(max)", nullable: false),
